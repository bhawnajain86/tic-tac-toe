...
void Patient::read()
{
    ...
    gets(gender);
    cout << "\n\n";
    cout << "Enter mobile no.(No ext. required): ";
    gets(phone_no);
    cout << "\n\n";
    cout << "Enter city: ";
    gets(city);
    cout << "\n\n";
    cout<< "Enter Date of positive(dd/mm/yy): ";
    gets(dop);
    cout << "\n\n";
    cout<< "Enter Result(Positive=P and Negative=N): ";
    gets(result);
    cout << "\n\n";
    cout << "Enter Date of negative(dd/mm/yy): ";
    gets(don);
    int count = 0;
    count = 0;
    while (count < 6)
...
void Patient::display(bool checkpositive)
{
    ...
    char buffer[200];
    cout << setiosflags(ios::left);
    cout <<setw(10)<<"Address"<< setw(15) << "Aadhar No." << setw(10) << "Name";
    cout << setw(5) << "Age" << setw(10) << "Gender";
    cout << setw(10) << "Phone no." << setw(10) << "City" << setw(10) << "Date of Positive";
    cout << setw(10) << "Result" << setw(10) << "Date of Negative" << endl
         << endl;
    ...
    for (indexnode *i : indexes)
    {
        ...
        if (!checkpositive || (checkpositive && !strcmp(result, "P")))
        {
            ...
            cout << setw(15) << aadhar_no << setw(10) << name;
            cout << setw(5) << age << setw(10) << gender;
            cout << setw(10) << phone_no << setw(10) << city << setw(10) << dop;
            cout << setw(10) << result << setw(10) << don << endl;
        }
    }
...
int main()
{
    ...
    do
    {
        ...
        case 3:
            ...
            cout<< "Positive Patient Details are: \n";
        ...
        case 4:
            ...
            header();
            s.opener(ifile, filename, ios::in, indexfile, indexfilename);
            cout<< "Searching based on Aadhar number \n";
            flag = s.search();
            if (flag == NULL)
